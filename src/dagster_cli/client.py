...
class DagsterClient:
    ...
    def list_jobs(self, repository_location: Optional[str] = None) -> List[Dict[str, Any]]:
                ...
                for repo in repositories:
                    ...
                    for asset_node in repo.get("assetNodes", []):
                        ...
                        assets.append({
                            ...
                            "location": location_name,
                            "repository": repo["name"],
                            "assetMaterializations": asset_node.get("assetMaterializations", [])
                        })
