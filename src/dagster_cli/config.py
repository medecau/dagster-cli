...
from dagster_cli.constants import CONFIG_DIR, CONFIG_FILE, DEFAULT_PROFILE, ENV_TOKEN, ENV_URL, ENV_LOCATION, ENV_REPOSITORY
...
class Config:
    ...
    def set_profile(self, profile_name: str, url: str, token: str, 
                    location: Optional[str] = None, repository: Optional[str] = None) -> None:
